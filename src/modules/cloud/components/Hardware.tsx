...
export default class Hardware extends Component<HardwareProps> {
  render() {
    ...
    const swap = data.swap ? (
      <Item size={20} bodyStyle={{ paddingVertical: 0, paddingLeft: 6, paddingRight: 15, borderBottomWidth: 0 }}>
        ...
        <Note style={fonts.subhead}>{data.swap.size.toFixed(0)} MB</Note>
            ...
            <View style={{ flex: 1, flexDirection: 'column' }}>
              <List itemStyle={{ paddingLeft: 0 }} style={{ marginBottom: 0, backgroundColor: 'transparent' }}>
                ...
                >
                  ...
                  <Note style={fonts.subhead}>{data.ram.size} MB</Note>
                ...
                >
                  ...
                  <Note style={fonts.subhead}>{data.disk.size} GB</Note>
